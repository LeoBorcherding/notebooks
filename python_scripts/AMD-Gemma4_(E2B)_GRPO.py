...
# get_ipython().system('uv pip install --system -qqq --upgrade --no-deps "transformers>=5.5.0" tokenizers "huggingface_hub>=1.5.0" "datasets==4.3.0" accelerate peft sentencepiece protobuf hf_transfer "trl>=0.28.0" unsloth unsloth_zoo')
# 
# import torch; torch._dynamo.config.recompile_limit = 64;
# get_ipython().system('uv pip install --system -qqq sentencepiece protobuf "datasets==4.3.0" "huggingface_hub>=0.34.0" hf_transfer torchcodec vllm')
# get_ipython().system('uv pip install --system -qqq --no-deps accelerate peft "transformers==5.5.0" tokenizers "trl==0.22.2"')
# 
# 
# # ### Unsloth
