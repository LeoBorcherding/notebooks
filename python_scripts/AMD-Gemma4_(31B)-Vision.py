...
# get_ipython().system('uv pip install --system -qqq sentencepiece protobuf "datasets==4.3.0" "huggingface_hub>=0.34.0" hf_transfer torchcodec')
# get_ipython().system('uv pip install --system -qqq --no-deps accelerate peft trl "transformers==5.5.0" tokenizers timm')
# 
# 
# # ### Unsloth
